...
class AttendanceActionsView extends StatefulWidget {
...
class _AttendanceActionsViewState extends State<AttendanceActionsView> {
  ...
  Future<void> _loadRecords() async {
    ...
    try {
      // final employeeController = EmployeeController.read(context);
      // if (employeeController.checkInOutToken == null ||
      //     employeeController.checkInOutToken!.isEmpty) {
      //   await employeeController.getCheckInOutToken();
      // }
      // final record = await employeeController.checkOutInRecords();
  ...
  List<Map<String, dynamic>> getActions(BuildContext context) {
    return [
      ...
      },
      {
        ...
        "id": "check_out",
        "title": 'checkOut'.tr,
        "description": 'checkOutDesc'.tr,
        "icon": Icons.logout,
      },
      {
        "fingerprintType": "3",
        "id": "temporary_leave",
        "title": 'temporaryLeave'.tr,
        "description": 'tempLeaveDesc'.tr,
        "icon": Icons.exit_to_app,
      },
      {
        "fingerprintType": "4",
        "id": "return",
        "title": 'returnFromLeave'.tr,
  ...
  String getFingerprintTypeName(int? type) {
    switch (type) {
      ...
      case 2:
        return 'checkOut'.tr;
      case 3:
        return 'temporaryLeave'.tr;
      case 4:
        return 'returnFromLeave'.tr;
      default:
        return "";
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      appBar: AppBarAtaa(title: args ?? 'attendanceReport'.tr),
  ...
  Widget _buildStatusCard(ColorScheme colors) {
    String statusText = 'notRegistered'.tr;
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text("${'attendanceStatus'.tr}: $statusText"),
          ],
        ),
      ),
    );
