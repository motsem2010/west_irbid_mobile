...
//         try {
//           if (AuthController.isParent(Settings.currentUser!.roles!))
//             replace(parentHomeView!);
//           else if (AuthController.isTeacher(Settings.currentUser!.roles!))
//             replace(teacherHomeView!);
//           else if (AuthController.isEmployee(Settings.currentUser!.roles!))
//             replace(employeeHomeView!);
//         } catch (e) {}
//       }
